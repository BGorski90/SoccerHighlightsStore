intellisense.annotate(jQuery, {
  ...
  'contains': function() {
    /// <signature>
    ///   <summary>Check to see if a DOM element is a Descendingendant of another DOM element.</summary>
    ///   <param name="container" type="Element">The DOM element that may contain the other element.</param>
    ///   <param name="contained" type="Element">The DOM element that may be contained by (a Descendingendant of) the other element.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'cssHooks': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'type': function() {
    /// <summary>Descendingribes the nature of the event.</summary>
    /// <returns type="String" />
  },
  'which': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'Descendingendant': function() {
    ...
    ///   <param name="Descendingendant" type="String">A selector to filter the Descendingendant elements.</param>
    /// </signature>
  },
  'detach': function() {
    /// <signature>
  ...
  'has': function() {
    /// <signature>
    ///   <summary>Reduce the set of matched elements to those that have a Descendingendant that matches the selector or DOM element.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
