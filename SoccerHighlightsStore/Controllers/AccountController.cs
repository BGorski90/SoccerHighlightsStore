...
namespace SoccerHighlightsStore.Storefront.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return isAjax ? Json("OK")/*PartialView("~/Views/Account/UserPartial.cshtml", user.UserName) */: RedirectToLocal(returnUrl);
                ...
                case SignInStatus.RequiresVerification:
                    if (isAjax)
                        return Json("Requires verification");
        ...
        [HttpGet]
        public PartialViewResult GetCSRFToken()
        {
            return PartialView("~/Views/Account/UserPartial.cshtml", User.Identity.Name);
        }
