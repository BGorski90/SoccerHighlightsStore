...
using SoccerHighlightsStore.Storefront;
    ...
    public class RouteTests
    {
            ...
            object routeProperties = null, string httpMethod = "GET")
        {
            ...
            routes.MapRoute(
                ...
                new { controller = "SoccerHighlightsStore.Storefront.Admin.Controllers.Home", action = "Index", id = UrlParameter.Optional }
            );
        ...
        {
            TestRouteMatch("//Admin/Home/Index", "Home", "Index");
        }
        ...
        public void TestOutgoingRoutes()
        {
            ...
            string result = UrlHelper.GenerateUrl(null, "Index", "Store", null,
                routes, context, true);

            // Assert
            Assert.AreEqual("/Store/Index", result);
        }
