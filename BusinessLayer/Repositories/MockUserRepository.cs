...
//using SoccerVideosMVCApplication.BusinessLayer.Entities;
//using System;
...
//namespace SoccerVideosMVCApplication.BusinessLayer.Repositories
//{
...
//            var result = sortOrder == "desc" ? _users.OrderByDescending(u => sortByProperty.GetValue(u)).AsQueryable().Take(limit)
